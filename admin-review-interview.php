        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="admin-interviews.php">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
                ...
                if (studentId && adminUserId) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            setTimeout(function() {
                                window.location.href = "admin-interviews.php";  // Redirect after success
                            }, 500);
                        } else {
            ...
            document.getElementById("confirmDeclineBtn").addEventListener("click", function() {
                ...
                alert("Sending request to decline interview... Please Wait");
