...
<head>
    ...
    <title>Sub-Admin - SJBPS Grade and Sections</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="sub-admin-grade-section.php">
            ...
            .then(data => {
                ...
                if (data.length === 0) {
                    ...
                    data.forEach((grade, index) => {
                        ...
                        row.innerHTML += `
                            ...
                            <td>
                                <form action="sub-admin-sections.php" method="POST" style="display:inline;">
                ...
                document.querySelectorAll(".section-btn").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        window.location.href = `sub-admin-sections.php?grade_level_id=${gradeLevelId}`;
                    });
                });
