...
<head>
    ...
    <title>Cashier - SJBPS Dashboard</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar pt-3">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="cashier-dashboard.php">
                            <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="cashier-payment-transaction.php">
            ...
            <div class="col-md-9 col-lg-10 px-md-4 pt-3">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 mb-4">
                        <a href="cashier-payment-transaction.php" class="text-decoration-none">
                            <div class="card-container">
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <a href="cashier-transaction-history.php" class="text-decoration-none">
                            <div class="card-container">
